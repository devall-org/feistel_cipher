...
- **New `time_bits` option** (default: 15) for time-based prefix. Use `time_bits: 0` to keep the old behavior.
...
def up do
  ...
  FeistelCipher.up_for_v1_functions(functions_prefix: "public", functions_salt: YOUR_SALT)
end
