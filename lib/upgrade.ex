      ...
      case extract_repo(igniter, app_name, opts[:repo]) do
        {:ok, repo} ->
          ...
          def up do
            ...
            FeistelCipher.up_v1_functions(functions_prefix: "#{functions_prefix}", functions_salt: :REPLACE_WITH_YOUR_SALT)
          end

          def down do
            FeistelCipher.down_v1_functions(functions_prefix: "#{functions_prefix}")
          end
          """
