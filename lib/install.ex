    ...
    def igniter(igniter) do
      ...
      case extract_repo(igniter, app_name, opts[:repo]) do
        {:ok, repo} ->
          migration = """
          def up do
            FeistelCipher.up_for_v1_functions(functions_prefix: "#{opts[:functions_prefix]}", functions_salt: #{opts[:functions_salt]})
          end

          def down do
            FeistelCipher.down_for_v1_functions(functions_prefix: "#{opts[:functions_prefix]}")
          end
          """
